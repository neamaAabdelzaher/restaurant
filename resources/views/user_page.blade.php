        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a class="btn border border-secondary mb-2 justify-content-end " href="{{route('restaurant.index')}}">All Meals</a>
                        <form id="myForm" action="{{route('restaurant.filter')}}" method="post">
                            @csrf
